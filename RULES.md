...
| R605 | REFUSE | An enrichment benchmark does not declare its decoy matching, or the match omits aromaticity | September 2026, this project: 252 dockings, decoys matched on heavy atoms, weight, logP, rotatable bonds and H-bond counts but not aromaticity. Across all 248 scored molecules aromaticity predicted the Vina score more strongly than anything matched (Spearman −0.544, about 0.85 kcal/mol per ring). The saturated triterpene actives, median 0 aromatic rings, were matched to drug-like decoys with a median of 4, and lost 19 times in 20 for ROC AUC 0.10. That reads as “the protocol ranks its best compounds worst” and is nothing of the kind. It refuses rather than warns because the result is not weaker, it is uninterpretable, and an uninterpretable enrichment number reads like evidence |
